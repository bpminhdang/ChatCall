...
namespace ChatApp
{
    public partial class ClientOld : Form
    {
        ...
        TcpClient tcpClientVideo = new TcpClient();
        ...
        private void btConnect_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                IPEndPoint ipEndPointServer = new IPEndPoint(System.Net.IPAddress.Parse("127.0.0.1"), 9001);
                tcpClientVideo.Connect(ipEndPointServer);
                netStreamVideo = tcpClientVideo.GetStream();
                Task.Run(() =>
                {
                    ReceiveMessage(tcpClient.Client, false);
                });
                Task.Run(() =>
                {
                    ReceiveMessage(tcpClientVideo.Client, true);
                });
        ...
        public void ReceiveMessage(Socket tcpClient_Client, bool tf)
        {
